...
#
# use o powershell:
# ~ powershell ./port_scanner.ps1 192.168.0.1
#
param($ip)
...
if (!$ip) {
    ...
    cls
    echo "---------------------------------------------------"
    echo "|          PORT SCANNER TCP - POWERSHELL          |"
    echo "|                                                 |"
